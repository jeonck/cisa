...
```mermaid
flowchart TD
    A["감사 헌장 초안 작성<br/>(IT 감사실)"] --> B["법무·컴플라이언스 검토<br/>(적법성·규정 적합성)"]
    B --> C["CAE 검토 및 승인<br/>(최고감사책임자)"]
    C --> D{"이사회/감사위원회<br/>최종 승인"}
    D -->|"승인"| E["헌장 공식 발효<br/>(전사 공지 및 게시)"]
    D -->|"수정 요청"| B
    E --> F["연간 자기평가<br/>(헌장 적정성 검토)"]
    F --> G{"중요 변경사항<br/>발생?"}
    G -->|"있음"| A
    G -->|"없음"| H["기존 헌장 유지<br/>(재승인 서명)"]
    H --> F
...
```mermaid
flowchart LR
    subgraph General["일반 표준 (1001-1008)"]
        G1["헌장 (1001)"]
        G2["조직적 독립성 (1002)"]
        G3["개인적 독립성 (1003)"]
        G4["합리적 기대 (1004)"]
    ...
    subgraph Performance["수행 표준 (1201-1207)"]
        P1["계획 (1201)"]
        P2["감독 (1202)"]
        P3["범위 (1203)"]
        P4["증거 수집 (1205)"]
    ...
    subgraph Reporting["보고 표준 (1401-1402)"]
        R1["보고 (1401)"]
        R2["후속 조치 (1402)"]
    end
    ...
    style G1 fill:#2563EB,stroke:#1D4ED8,color:#fff
    style G2 fill:#2563EB,stroke:#1D4ED8,color:#fff
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>1. 감사 헌장 문서 요청 및 버전 확인<br/>2. 최종 개정일과 조직 변화 시점 비교<br/>3. 헌장의 목적·권한·책임 요소 완전성 검토</td>
      <td>감사 헌장 원본<br/>개정 이력 기록<br/>버전 관리 로그</td>
    </tr>
    <tr>
      <td><strong>AC-02</strong></td>
      <td>이사회/감사위원회 공식 승인 확인</td>
      <td>1. 감사위원회 회의록에서 헌장 승인 결의 확인<br/>2. 승인 서명자의 권한 적정성 검토<br/>3. 승인 일자와 헌장 발효일 일치 여부 확인</td>
      <td>감사위원회 회의록<br/>이사회 결의서<br/>서명된 헌장 사본</td>
    </tr>
    <tr>
      <td><strong>AC-03</strong></td>
      <td>조직적 독립성 구조 적정성 평가</td>
      <td>1. IT 감사실의 보고 체계 조직도 검토<br/>2. CAE의 이사회/감사위원회 직접 보고 경로 확인<br/>3. 감사 대상 부서와의 보고선 분리 여부 확인</td>
      <td>조직도 (최신본)<br/>보고 체계 기술서<br/>CAE 임명 문서</td>
    </tr>
    <tr>
      <td><strong>AC-04</strong></td>
      <td>감사인 개인 독립성 관리 체계 확인</td>
      <td>1. 이해충돌 신고 양식 및 절차 검토<br/>2. 현 감사 팀원의 이해충돌 신고서 확인<br/>3. 자기검토 위협 사례 존재 여부 확인</td>
      <td>이해충돌 신고서<br/>독립성 선언서<br/>이해충돌 관리 대장</td>
    </tr>
    <tr>
      <td><strong>AC-05</strong></td>
      <td>연간 자기평가(Self-Assessment) 수행 확인</td>
      <td>1. 전년도 자기평가 보고서 요청<br/>2. 자기평가 범위(ITAF 준수 여부) 적정성 검토<br/>3. 자기평가 결과의 경영진 보고 여부 확인</td>
      <td>연간 자기평가 보고서<br/>개선 계획서<br/>경영진 보고 기록</td>
    </tr>
    <tr>
      <td><strong>AC-06</strong></td>
      <td>ISACA 윤리 강령 준수 체계 확인</td>
      <td>1. 윤리 강령 교육 이수 기록 검토<br/>2. 윤리 위반 신고 채널 존재 여부 확인<br/>3. 최근 3년 윤리 관련 징계 사례 조회</td>
      <td>윤리 교육 이수증<br/>서약서 원본<br/>징계 기록부</td>
    </tr>
  </tbody>
</table>
